...
{
public:
	 CLayoutItem(CString,unsigned int);	//14
	 CLayoutItem(void);	//15
...
public:
	...
	static void		AddTempString(long,CString,int);	//154
...
protected:
	static class	CMap<unsigned long,unsigned long,CString,CString>  m_ContextStringMap;	//1627
	static int		m_OwnerDraw;	//1628
	static class	CMap<long,long,CString,CString>  m_PopUpStringMap;	//1629
	static class	CStringArray  m_blackList;	//1631
	static class	CMap<unsigned long,unsigned long,CString,CString>  m_stringMap;	//1635
};
...
public:
	...
	virtual int  AddColumn(CString const &,int,int,int);	//135
...
public:
	...
	virtual int  ColumnExists(CString const &)const;	//202
...
public:
	...
	virtual int  DeleteColumn(CString const &);	//299
...
public:
	...
	virtual int  FindColumn(CString const &,int &,int &)const;	//426
protected:
...
public:
	...
	virtual CString   GetColumnHeading(int)const;	//479
	...
	virtual CString   GetItemText(int,int)const;	//571
...
public:
	virtual int  InsertColumn(int,CString const &,int,int,int,int);	//776
	virtual int  InsertColumn(int,class SECListCtrl::Column *,int);	//777
	virtual int  InsertItem(int,CString const &);	//778
...
protected:
	...
	virtual int  NotifyEndLabelEdit(int,int,CString &,int)const;	//893
...
public:
	...
	virtual void  SetColumnHeading(int,CString const &);	//1328
...
using SECListCtrl::DeleteItem;
using SECListCtrl::EditLabel;
using SECListCtrl::EnsureVisible;
using SECListCtrl::GetItemData;
using SECListCtrl::GetItemState;
using SECListCtrl::GetNextItem;
using SECListCtrl::HitTest;
using SECListCtrl::IsSelected;
using SECListCtrl::NotifyGetDispInfo;
using SECListCtrl::NotifyGetDispInfoEx;
using SECListCtrl::NotifySetDispInfo;
using SECListCtrl::NotifySetDispInfoEx;
using SECListCtrl::SelectDropTarget;
using SECListCtrl::SelectItem;
using SECListCtrl::SelectItemRange;
using SECListCtrl::SetFirstVisible;
using SECListCtrl::SetItemData;
using SECListCtrl::SetItemState;
using SECListCtrl::SetItemText;
using SECListCtrl::Update;
using SECListCtrl::GetItemRect;
using SECListCtrl::GetItemText;
using SECListCtrl::InsertItem;
...
public:
	...
	int  GetItemString(struct _TREEITEM *,int,CString &);	//570
	CString   GetItemText(struct _TREEITEM *,int)const;	//573
...
protected:
	...
	void  MeasureText(class CDC *,class SECTreeCtrl::Node *,CString const &,class CRect &)const;	//870
public:
...
protected:
	...
	virtual int  NotifyEndLabelEdit(int,int,CString &,int)const;	//894
...
public:
	...
	int  SetItemString(struct _TREEITEM *,int,CString const &);	//1375
...
public:
	...
	CString   GetPaneText(int)const;	//657
	void  GetPaneText(int,CString &)const;	//658
...
protected:
	virtual void  GetMessageString(unsigned int,CString &)const;	//630
...
IMPORT_1C int __cdecl GetFilePathAndName(char const *,CString &,CString &);
