...
//	static int  GetSubString(CString &,char const *,int);	//1102
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//951
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//952
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//953
...
public:
	...
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//388
	virtual int  CallAsProc(int,CValue * *);	//396
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//954
	virtual char const *  GetPropName(int,int)const;	//993
	virtual int  GetPropVal(int,CValue &)const;	//1014
...
public:
	...
	void  CreateObjViewFilter(class CLogFilter *,CString);	//457
	void  CreateObjectFilter(class CLogFilter *,CValue *);	//510
	void  CreateRunmodeFilter(class CLogFilter *,CString);	//513
protected:
	CString   CreateTempLogDB(int,class CLogDB *,class CExpression *,class CDate,long *);	//514
public:
	void  CreateUserFilter(class CLogFilter *,CString);	//515
...
public:
	...
	void  GetLogParams(int &,CString &);	//776
	class CLogDB *  GetMainLog(void);	//780
	class CLogModule *  GetModule(CString);	//858
	class CLogModule *  GetModuleTerm(CString);	//860
...
public:
	...
	void  ShowUserLog(CString);	//1830
	long  StartLogging(void);	//1838
	int  StartSecondLog(CString);	//1841
...
public:
	...
	void  GetFromHisrory(CStringArray &);	//742
protected:
...
public:
	int  GetPermStrins(class CItemList *,CString &,CString &);	//981
	int  GetPermType(CString);	//982
...
//	void  `default constructor closure'(void);	//323
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//955
...
//	void  `default constructor closure'(void);	//324
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//956
...
//	void  `default constructor closure'(void);	//325
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//957
	virtual char const *  GetPropName(int,int)const;	//995
	virtual int  GetPropVal(int,CValue &)const;	//1015
	...
	void  SetPeriodValue(CString);	//1797
};
...
//	void  `default constructor closure'(void);	//326
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//390
	virtual int  CallAsProc(int,CValue * *);	//397
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//958
	virtual char const *  GetPropName(int,int)const;	//996
	virtual int  GetPropVal(int,CValue &)const;	//1016
	...
	virtual int  SetPropVal(int,CValue const &);	//1801
};
...
public:
	...
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//391
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//959
	virtual char const *  GetPropName(int,int)const;	//997
	virtual int  GetPropVal(int,CValue &)const;	//1017
...
protected:
	...
	CString   NumericToString(class CNumeric &);	//1331
...
protected:
	CString   SetErrorState(class CNumeric);	//1758
public:
...
public:
	CString const &  GetTitle(void);	//1121
protected:
...
public:
	...
	void  SetTitle(CString const &);	//1818
...
public:
	...
	static int  IDToPath(long,char const *,CString &,CTypedCont * *,int);	//1178
...
//	void  `default constructor closure'(void);	//327
	...
	void  FX_String(int,CString &,int);	//620
	void  FX_String(class CFieldCSV *,CString &,int);	//621
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//960
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//961
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//962
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//963
...
public:
	...
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//392
	virtual int  CallAsProc(int,CValue * *);	//398
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//964
	virtual char const *  GetPropName(int,int)const;	//1002
	virtual int  GetPropVal(int,CValue &)const;	//1018
...
public:
	...
	virtual int  DrawItem(class CDC &,class CRect &,CString &,int);	//575
	virtual void  GetData(CString &);	//710
};
...
public:
	...
	virtual int  DrawItem(class CDC &,class CRect &,CString &,int);	//576
	virtual void  GetData(CString &);	//711
};
...
//	void  `default constructor closure'(void);	//331
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//965
...
public:
	...
	void  ComposeTitle(CString &,CString &);	//422
protected:
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//966
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//967
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//968
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//969
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//970
...
public:
	...
	void  AddCompareStrings(int,class CRightInfo *,class CRightInfo *,CString &,CString &,CString);	//342
...
public:
	void  FullDifferens(class CRightsContainer *,CString &,CString &,class CMetaDataCont *,class CMetaDataCont *,int);	//660
	int  GetCount(void)const;	//695
	CString   GetDescription(void);	//718
	void  GetDifferens(class CRightsContainer *,int,class CMetaDataObj *,class CMetaDataObj *,CString &,CString);	//720
	CStringArray *  GetFullNameList(void);	//744
	...
	void  ObjectDifferens(class CRightsContainer *,int,class CMetaDataObj *,class CMetaDataObj *,CString &,CString &,CString);	//1332
protected:
	virtual int  RemoveInfo(unsigned int,long);	//1676
public:
	virtual void  Serialize(class CArchive &,int);	//1724
	void  SetDescription(CString);	//1750
...
//	void  `default constructor closure'(void);	//332
	static CString   ConvertTemplate(char const *,char const *,class CPoint &,int &);	//426
protected:
...
//	static struct ATL::_ATL_INTMAP_ENTRY const *  _GetEntries(void);	//2022
	...
	virtual long  getType(CType &);	//2137
	...
	virtual long  putType(CType const &);	//2225
...
public:
	CString   GetStatusLine(void)const;	//1100
protected:
...
//	void  `default constructor closure'(void);	//334
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//971
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//972
...
public:
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//973
...
public:
	...
	CString   GetTextFull(int);	//1118
	void  GetTextFull(int,CString &);	//1119
...
protected:
	void  SplitString(CString,CString &,CString &);	//1834
...
{
public:
	 CTableCSV(int,CString);	//98
	 ~CTableCSV(void);	//195
//	void  `default constructor closure'(void);	//335
	class CFieldCSV *  AddField(CString,long,int);	//343
	int  AddRecord(void);	//358
	unsigned long  AddToFilteredFile(CString,class CExpression *,long *,long);	//360
	int  Archive(CString,class CDate,CString);	//370
protected:
...
public:
	...
	unsigned long  CreateFilteredFile(CString,class CExpression *,long *);	//451
protected:
...
public:
	...
	virtual void  FX_String(int,CString &,int);	//622
	virtual void  FX_String(class CFieldCSV *,CString &,int);	//623
...
public:
	CString   GetTableFile(void);	//1105
	...
	long  OpenAccess(CString,int);	//1599
	long  Prev(long,class CFetchCSV *);	//1622
protected:
	void  ProcessFieldBounds(void);	//1629
public:
	static void  ProcessQuotes(CString &);	//1631
...
public:
	...
	CString   GetTagString(char const *,char const *);	//1111
protected:
...
public:
	...
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//393
	virtual int  CallAsProc(int,CValue * *);	//399
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//974
	virtual char const *  GetPropName(int,int)const;	//1011
	virtual int  GetPropVal(int,CValue &)const;	//1019
...
public:
	...
	int  GetAccelPresent(unsigned int,CString &)const;	//663
	...
	CString   GetDescription(void);	//719
	int  GetLongText(unsigned int,CString &)const;	//777
	int  GetLongText(unsigned int,char *,int)const;	//778
	int  GetParamCode(unsigned int,CString &,int)const;	//947
	int  GetParamCode(unsigned int,char *,int,int)const;	//948
	int  GetRealCode(unsigned int,CString &,int)const;	//1026
	int  GetRealCode(unsigned int,char *,int,int)const;	//1027
	int  GetShortText(unsigned int,CString &,int)const;	//1091
...
public:
	...
	void  SetDescription(CString);	//1751
	void  SetStatusStr(unsigned int,CString &)const;	//1812
...
public:
	...
	int  GetParamCode(CString &,int)const;	//949
...
public:
	...
	void  GetInfo(long &,CString &)const;	//760
	class CPictureCont *  GetPictCont(void);	//986
	CString const &  GetSourcePathName(void)const;	//1095
	int  GetTablesName(CStringArray &);	//1109
	...
	void  SetInfo(long const &,CString const &);	//1776
...
protected:
	void  AddField(CValue * *);	//344
private:
	void  AddFld(char const *,int,int,int);	//345
	void  AddInd(char const *,char const *,int,int,char const *);	//349
protected:
	void  AddIndex(CValue * *);	//350
	void  AddRec(CValue * *);	//357
	void  Bof(CValue &,CValue * *);	//383
public:
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//394
	virtual int  CallAsProc(int,CValue * *);	//400
private:
	void  Cancel(void);	//402
	void  CheckCBError(void);	//405
protected:
	void  ClearRec(CValue * *);	//414
	void  CloseBase(CValue * *);	//418
private:
	void  CloseDB(void);	//419
protected:
	void  CopyRec(CValue * *);	//429
	void  CreateBase(CValue * *);	//443
private:
	void  CreateIndex(CValue &,CValue * *);	//454
protected:
	void  DelRec(CValue * *);	//532
	void  Eof(CValue &,CValue * *);	//589
	void  FieldNumber(CValue &,CValue * *);	//629
	void  FindByKey(CValue &,CValue * *);	//643
	void  FindRec(CValue &,CValue * *);	//651
	void  FirstRec(CValue &,CValue * *);	//657
public:
	int  GetCodePage(void)const;	//682
protected:
	void  GetField(CValue &,CValue * *);	//730
	void  GetFieldInfo(CValue * *);	//732
private:
	void  GetFld(int,CValue &)const;	//739
protected:
	void  GetIndexInfo(CValue * *);	//759
public:
	void  GetKeyVal(int,CValue &);	//768
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//975
	virtual char const *  GetPropName(int,int)const;	//1012
	virtual int  GetPropVal(int,CValue &)const;	//1020
	virtual char const *  GetTypeString(void)const;	//1127
protected:
	void  Goto(CValue * *);	//1143
public:
	virtual int  HasRetVal(int)const;	//1173
	virtual int  IsPropReadable(int)const;	//1255
	virtual int  IsPropWritable(int)const;	//1271
protected:
	void  LastRec(CValue &,CValue * *);	//1290
	void  NextRec(CValue &,CValue * *);	//1329
	void  OpenBase(CValue * *);	//1600
private:
	void  OpenDB(char *,char *,int);	//1601
protected:
	void  Pack(CValue * *);	//1603
	void  PrevRec(CValue &,CValue * *);	//1624
private:
	void  ReadFld(int,CValue &,int)const;	//1639
protected:
	void  RecCount(CValue &,CValue * *);	//1643
	void  RecDeleted(CValue &,CValue * *);	//1644
	void  RecNo(CValue &,CValue * *);	//1645
	void  RecallRec(CValue * *);	//1647
	void  Reindex(CValue * *);	//1659
private:
	void  ReleaseFieldInfo(void);	//1663
	void  ReleaseIndexInfo(void);	//1669
	void  Save(void);	//1691
protected:
	void  SelectIndex(CValue &,CValue * *);	//1713
	void  SetCodePage(CValue &,CValue * *);	//1740
	void  SetField(CValue * *);	//1766
private:
	void  SetFld(int,CValue const &);	//1767
public:
	void  SetKeyVal(int,CValue);	//1781
	virtual int  SetPropVal(int,CValue const &);	//1802
private:
	int  SkipDeleted(int);	//1832
	void  WriteFld(int,CValue const &,int);	//1907
protected:
	void  Zap(CValue * *);	//1914
private:
...
public:
	...
	virtual int  CallAsFunc(int,CValue &,CValue * *);	//395
	virtual int  CallAsProc(int,CValue * *);	//401
	void  Done(void);	//571
	...
	virtual int  GetParamDefValue(int,int,CValue *)const;	//976
	virtual char const *  GetPropName(int,int)const;	//1013
	virtual int  GetPropVal(int,CValue &)const;	//1021
	...
	virtual int  SetPropVal(int,CValue const &);	//1803
};
...
IMPORT_1C int __cdecl CheckPasswordString(CString,int,int,char const *);
IMPORT_1C void __cdecl CorrectCommand(CString &,CString &,CString &);
IMPORT_1C void __cdecl CorrectCommand(CString &,CString &);
IMPORT_1C CString  __cdecl CriptPasswordString(char const *);
...
IMPORT_1C CString  __cdecl GetContainerDescription(char const *);
IMPORT_1C int __cdecl GetContextProp(class CBLContext *,CValue &,CValue * *);
IMPORT_1C class CDocType * __cdecl GetGlobalDocType(void);
IMPORT_1C class CBLModule7 * __cdecl GetGlobalModule(void);
IMPORT_1C CString  __cdecl GetLastPPPString(void);
IMPORT_1C CString  __cdecl GetModuleFullName(long, LPCSTR szModulePath, int nID, class CMetaDataCont *);
IMPORT_1C int __cdecl GetPasswordString(CString &,char const *,int);
IMPORT_1C class CSearchHistoryProfile * __cdecl GetReplaceHistory(void);
IMPORT_1C class CSplash * __cdecl GetSplashWnd(void);
IMPORT_1C CType  __cdecl GetTypeFromValue(CValue *,int,int,int *,int);
IMPORT_1C CString  __cdecl HashPasswordString(char const *);
...
IMPORT_1C int __cdecl IsTypeAvailable(CType const &,unsigned int);
...
IMPORT_1C CString  __cdecl ReadStatusLine(void);
IMPORT_1C void __cdecl ReportEventA(CString,long,enum EventType,CString,CString,CString);
IMPORT_1C void __cdecl ReportEventA(CString,struct LogEventInfo *);
IMPORT_1C int __cdecl SetContextProp(class CBLContext *,CValue * *);
IMPORT_1C int __cdecl SetModalMode(int);
IMPORT_1C int __cdecl SetTypedValueWithTest(CTypedValue *,CValue const *);
IMPORT_1C int __cdecl TestSetTypedValue(CType const *,CValue const *);
